...
public abstract class IngressRuleGenerator extends MeteredRuleGenerator {
    ...
    protected SpeakerCommandData buildMeter(MeterId meterId) {
        if (meterId == null || !flowPath.getSrcSwitch().getFeatures().contains(METERS)) {
            return null;
        }
    ...
    protected static boolean isFullPortFlow(FlowEndpoint flowEndpoint) {
