...
import org.openkilda.rulemanager.factory.generator.service.DropRuleGenerator;
...
public class RuleManagerServiceRulesTest {
    ...
    public void shouldUseCorrectServiceRuleGeneratorsForSwitchInSingleTableMode() {
        ...
        assertTrue(generators.stream().anyMatch(g -> g instanceof DropRuleGenerator));
    ...
    public void shouldUseCorrectServiceRuleGeneratorsForSwitchInMultiTableMode() {
        ...
        assertEquals(4, generators.stream().filter(g -> g instanceof DropRuleGenerator).count());
    }
}
