...
public class YFlowCreateServiceTest extends AbstractYFlowTest {
    ...
    public void shouldFailOnUnsuccessfulMeterInstallation()
        ...
        // and
        handleSpeakerCommandsAndFailInstall(flowCreateService, flowDeleteService, service, "test_successful_yflow");
    ...
    public void shouldFailOnTimeoutDuringMeterInstallation()
        ...
        verifyYFlowStatus(request.getYFlowId(), FlowStatus.IN_PROGRESS);
        // and
        handleSpeakerCommandsAndTimeoutInstall(flowCreateService, flowDeleteService, service, "test_successful_yflow");
    ...
    public void shouldFailOnUnsuccessfulValidation()
        ...
        verifyYFlowStatus(request.getYFlowId(), FlowStatus.IN_PROGRESS);
        // and
        handleSpeakerCommandsAndFailVerify(flowCreateService, flowDeleteService, service, "test_successful_yflow");
    ...
    public void shouldFailOnTimeoutDuringMeterValidation()
        ...
        verifyYFlowStatus(request.getYFlowId(), FlowStatus.IN_PROGRESS);
        // and
        handleSpeakerCommandsAndTimeoutVerify(flowCreateService, flowDeleteService, service, "test_successful_yflow");
    ...
    private void handleSpeakerCommandsAndFailInstall(FlowCreateService flowCreateService,
                                                     FlowDeleteService flowDeleteService,
                                                     YFlowCreateService service, String commandKeyToFail) {
        handleSpeakerCommands((key, request) -> {
            SpeakerFlowSegmentResponse commandResponse = request.isInstallRequest() && key.equals(commandKeyToFail)
                    ? buildErrorSpeakerResponse(request) : buildSuccessfulSpeakerResponse(request);
            handleAsyncResponse(flowCreateService, flowDeleteService, service, key, commandResponse);
        });
    }

    private void handleSpeakerCommandsAndFailVerify(FlowCreateService flowCreateService,
                                                    FlowDeleteService flowDeleteService,
                                                    YFlowCreateService service, String commandKeyToFail) {
        handleSpeakerCommands((key, request) -> {
    ...
    private void handleSpeakerCommandsAndTimeoutInstall(FlowCreateService flowCreateService,
                                                        FlowDeleteService flowDeleteService,
                                                        YFlowCreateService service, String commandKeyToFail) {
        handleSpeakerCommands((key, request) -> {
    ...
    private void handleTimeout(FlowCreateService flowCreateService, FlowDeleteService flowDeleteService,
                               YFlowCreateService yFlowCreateService, String key) {
        try {
        ...
        try {
            flowDeleteService.handleTimeout(key);
        } catch (UnknownKeyException ex) {
            //skip
        }
        try {
    ...
    private void handleSpeakerCommandsAndTimeoutVerify(FlowCreateService flowCreateService,
                                                       FlowDeleteService flowDeleteService,
                                                       YFlowCreateService service, String commandKeyToFail) {
        handleSpeakerCommands((key, request) -> {
