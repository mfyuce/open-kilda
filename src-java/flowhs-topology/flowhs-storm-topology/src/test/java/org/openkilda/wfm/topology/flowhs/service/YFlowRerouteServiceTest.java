...
public class YFlowRerouteServiceTest extends AbstractYFlowTest {
    ...
    private void processRerouteRequest(YFlowRerouteRequest yFlowRerouteRequest) throws DuplicateKeyException {
        YFlowRerouteService service = makeYFlowUpdateService(0);
    ...
    private void processRerouteRequestAndSpeakerCommands(YFlowRerouteRequest request)
        ...
        YFlowRerouteService service = makeYFlowUpdateService(flowRerouteService, 0);
    ...
    private void processRerouteRequestAndSpeakerCommands(YFlowRerouteRequest request,
            ...
            throws DuplicateKeyException {
        FlowRerouteService flowUpdateService = makeFlowRerouteService(0);
        YFlowRerouteService service = makeYFlowUpdateService(flowUpdateService, 0);
        service.handleRequest(request.getYFlowId(), new CommandContext(), request);
    ...
    private YFlowRerouteService makeYFlowUpdateService(int retriesLimit) {
        return makeYFlowUpdateService(makeFlowRerouteService(retriesLimit), retriesLimit);
    }

    private YFlowRerouteService makeYFlowUpdateService(FlowRerouteService flowRerouteService,
                                                      int retriesLimit) {
