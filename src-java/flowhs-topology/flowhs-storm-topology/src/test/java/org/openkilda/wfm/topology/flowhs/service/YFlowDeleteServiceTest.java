...
public class YFlowDeleteServiceTest extends AbstractYFlowTest {
    ...
    public void shouldDeleteOnUnsuccessfulMeterRemoval() throws DuplicateKeyException {
        ...
        // and
        handleSpeakerCommandsAndFailRemove(flowDeleteService, service, yFlowId);
    ...
    public void shouldDeleteOnTimeoutDuringMeterRemoval() throws DuplicateKeyException {
        ...
        verifyYFlowStatus(yFlowId, FlowStatus.IN_PROGRESS);
        // and
        handleSpeakerCommandsAndTimeoutRemove(flowDeleteService, service, yFlowId);
    ...
    private void processRequestAndSpeakerCommands(String yFlowId) throws DuplicateKeyException {
        ...
        handleSpeakerCommands((key, speakerRequest) -> {
            ...
            handleAsyncResponse(flowDeleteService, service, key, commandResponse);
        });
    ...
    private void handleAsyncResponse(FlowDeleteService flowDeleteService, YFlowDeleteService service,
    ...
    private void handleSpeakerCommandsAndFailRemove(FlowDeleteService flowDeleteService,
                                                    YFlowDeleteService service, String commandKeyToFail) {
        handleSpeakerCommands((key, request) -> {
            SpeakerFlowSegmentResponse commandResponse = request.isRemoveRequest() && key.equals(commandKeyToFail)
                    ? buildErrorSpeakerResponse(request) : buildSuccessfulSpeakerResponse(request);
            handleAsyncResponse(flowDeleteService, service, key, commandResponse);
        });
    }

    private void handleSpeakerCommandsAndTimeoutRemove(FlowDeleteService flowDeleteService,
                                                       YFlowDeleteService service, String commandKeyToFail) {
        handleSpeakerCommands((key, request) -> {
